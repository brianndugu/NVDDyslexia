package com.example.nvd_dyslexia;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void displayResult(int score) {
        String message;
        if (score >= 10) {
            message = "High Likelihood of Dyslexia  please consult a specialist";
        } else if (score >= 5){ ;
        message = "moderate likelihood of Dyslexia consider seeking professional advice";
    }else {
            message = "moderate likelihood of Dyslexia keep monitoring development";
        }
